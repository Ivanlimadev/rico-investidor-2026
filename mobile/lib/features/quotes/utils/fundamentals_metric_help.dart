...
const _revenueHelp = FundamentalsMetricHelp(
  title: 'Revenue',
  description:
      'Total sales generated by the company in the period. '
      'Net Revenue deducts returns and allowances from gross revenue. '
      'It is the top line of the income statement — before costs, '
      'expenses, interest and taxes.',
  calculation: 'Net Revenue = Gross Revenue − returns and allowances',
  interpretation:
      'Revenue growth over time indicates business expansion. '
      'Compare with margin trends to assess quality of growth.',
);

const _netRevenueHelp = FundamentalsMetricHelp(
  title: 'Net Revenue',
  description:
      'Total sales generated by the company in the period. '
      'Net Revenue deducts returns and allowances from gross revenue. '
...
const _localHelp = <String, FundamentalsMetricHelp>{
  ...
  'P/L': FundamentalsMetricHelp(
    ...
    description:
        ...
        'É um indicador de valuation: quanto o mercado paga por cada US\$ 1 de lucro.',
  ...
  'Receita': _revenueHelp,
  'Receita líq.': _netRevenueHelp,
  ...
  'VP/cota': FundamentalsMetricHelp(
    ...
    description:
        'Equity (assets minus liabilities) divided by shares outstanding. '
        'The accounting value of each share.',
    calculation: 'Book Value per Share = Stockholders Equity ÷ Shares Outstanding',
    interpretation: 'Used in P/B ratio. Do not confuse with market price per share.',
  ),
  ...
  'Dív./PL': FundamentalsMetricHelp(
    ...
    description:
        'Ratio between total debt and shareholders equity. Measures financial leverage.',
  ...
  'Beta': FundamentalsMetricHelp(
    title: 'Beta',
    description:
        'Sensitivity of the stock relative to the market (S&P 500). '
        'Measures relative volatility, not company quality.',
    interpretation:
        'Beta ≈ 1 moves with the index. Beta > 1 amplifies gains and losses. '
        'Beta < 1 tends to be less volatile than the market.',
  ),
