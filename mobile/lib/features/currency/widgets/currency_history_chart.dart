...
class CurrencyHistoryChart extends StatefulWidget {
  ...
  @override
  State<CurrencyHistoryChart> createState() => _CurrencyHistoryChartState();
}

class _CurrencyHistoryChartState extends State<CurrencyHistoryChart> {
  int? _selectedIndex;
  ...
  Widget build(BuildContext context) {
    ...
    final sorted = List<CurrencyHistoryPointDto>.from(widget.history)
    ...
    return Card(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text('Histórico PTAX', style: Theme.of(context).textTheme.titleSmall),
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  const Spacer(),
                  Text(
                    formatCurrencyRate(selected.value, widget.pair),
